...
const AddProperty = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      axios
        .post('http://localhost:5000/property/add', values)
        .then((result) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-md flex">
        {/* Left Side: Image */}
        <div
          className="w-1/2 hidden md:block bg-cover bg-center rounded-l-lg"
          style={{ backgroundImage: "url('https://images.pexels.com/photos/2581922/pexels-photo-2581922.jpeg?auto=compress&cs=tinysrgb&w=600/600x800')" }}
        ></div>
